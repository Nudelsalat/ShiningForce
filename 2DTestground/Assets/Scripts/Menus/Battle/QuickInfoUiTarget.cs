...
//This whole class is kinda stupid, as QuickInfoUi would do the exact same.
//but as it is would have to lift the singleton restriction, either:
//A) each battle map/scene would add to an additional class, therefore it's not unique
//B) all the DONTDESTROY objects would reference old instantiations of that class.
public class QuickInfoUiTarget : MonoBehaviour
{
    ...
    public static QuickInfoUiTarget Instance;
